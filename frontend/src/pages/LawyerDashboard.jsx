...
const s = {
  ...
  navBtn:     { display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 8, background: "transparent", border: "none", color: "#94a3b8", cursor: "pointer", fontSize: 13, fontWeight: 500, textAlign: "left", width: "100%" },
  ...
  logoutBtn:  { margin: "auto 12px 0", padding: "10px 12px", background: "transparent", border: "none", color: "#64748b", cursor: "pointer", fontSize: 13, borderRadius: 8 },
  ...
  assistantInputRow: { display: "flex", alignItems: "flex-end", gap: 10, padding: "12px 16px", borderTop: "1px solid #1e2d45", background: "#0d1424" },
